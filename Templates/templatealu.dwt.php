	...
	<div style = "float: left; height: 450px; width: 100%; background-color:#cccccc">
		<div style = "float: left; height: 450px; width: 20%; background-color:#CC6699" class="Menu">
		  <table width="150px" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td width="20">&nbsp;</td>
              <td><a href="../intalu/curso.php?Codigo=<?php echo $row_rsCursos['CodCurGra']; ?>"><?php echo $row_rsCursos['Curso']; ?></a></td>
            </tr>
		  ...
		  <table width="150" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td width="20">&nbsp;</td>
              <td><a href="../intalu/lista.php">Participantes</a></td>
            </tr>
          </table>
		  ...
		  <table width="150" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td><a href="../intalu/mensaje.php?Codigo=<?php echo $_GET['Codigo']; ?>">Msjs del Docente </a></td>
            </tr>
            <!--<tr>
              <td>&nbsp;</td>
		  ...
		  <table width="150" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td width="20">&nbsp;</td>
              <td><a href="../intalu/evaluacion.php?Codigo=<?php echo $_GET['Codigo']; ?>">Notas Actuales</a></td>
            </tr>
			<? }?>
            <tr>
              <td>&nbsp;</td>
              <td><a href="../intalu/asistencia.php">Record de Asistencia</a></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
