...
<div style = "display: table; margin-left: auto; margin-right: auto; width: 90%; background-color:#66FF00">
    ...
    <div style = "float: right; height: 450px; width: 80%; background-color:#9999FF">
		...
		<h1>Registrar Asistencia</h1><hr /><br />
...
?>
		  ...
		  <table width="80%" border="0" cellspacing="1" cellpadding="0" class="table">
            ...
            <tr>
              ...
              <td width="120">
                <label>
                  <input name="optAsistecia[<?php echo $row_rsLista['CodMatricula']; ?>]" type="radio" value="1" checked="checked" />
                </label>
                <label>
                  <input type="radio" name="optAsistecia[<?php echo $row_rsLista['CodMatricula']; ?>]" value="2" />
                </label>
                <label>
                  <input type="radio" name="optAsistecia[<?php echo $row_rsLista['CodMatricula']; ?>]" value="3" />
                </label>
                <label>
                  <input type="radio" name="optAsistecia[<?php echo $row_rsLista['CodMatricula']; ?>]" value="4" />
                </label>
                <label>
                  <input type="radio" name="optAsistecia[<?php echo $row_rsLista['CodMatricula']; ?>]" value="5" />
                </label>            
			  </td>
            </tr>
              <?php 
