...
<table width="90%" border="0" align="center"><tr><td>
	<table width="100%" border="0" cellpadding="0">
		...
		<h1>Alumno</h1><hr /><br />
		<form id="form1" name="form1" method="post" autocomplete="Off" action="php/acaalumno.php">
		<table width="380px" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<td width="35" align="right">
			  <a href="acanewalumno.php" title="Nuevo"><img src="../imagenes/icono/aadduser.png" width="32" border="0"/></a>
            </td>
          </tr>
        </table>
		<div style="height:5px"></div>
