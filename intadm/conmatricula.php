...
$(document).ready(function(){
	$("#btConsulta").click(function (){
	   ...
	   url: "php/conmatricula.php", //SCRIPT que procesara los datos, establecer ruta relativa o absoluta
...
<table width="90%" border="0" align="center"><tr><td>
	<table width="100%" border="0" cellpadding="0">
		...
		<h1>Consulta de Alumno Matriculados</h1><hr /><br />
		  ...
		  <table width="610" border="0" cellspacing="2" cellpadding="0">
			...
			<tr>
			  ...
			  <td align="right">
				...
				onclick="document.form1.action='reporte/repmatricula.php'; document.form1.target='_blank'; document.form1.submit()"; />
			  </td>
			</tr>
		  </table>
		</form>
