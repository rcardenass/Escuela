...
<table width="90%" border="0" align="center"><tr><td>
	<table width="100%" border="0" cellpadding="0">
		...
		<h1>
		<div style="width:100%">
			<div style="width:300px; height:auto; float:left; padding-top:20px">Informe General de Alumno</div>
		 ...
		 <div style="text-align:right;padding-right:5px"><a href="infalumnodetalle.php?Codigo=<? echo $_GET['Codigo'];?>"><img src="../imagenes/icono/stats.png" width="35" border="0" title="Informe Detallado"/></a></div>
		<table width="700" border="0" cellspacing="2" cellpadding="0" class="table">
		  ...
		  <tr>
			...
			<td width="75"><div align="center"><? echo $row_rsGeneral['CodOperacion']; ?></div></td>
			<td width="80"><? echo $row_rsGeneral['FechaCreacion']; ?></td>
			<td width="80"><? echo $row_rsGeneral['Hora']; ?></td>
			<td><div style="text-align:left;padding-left:10px"><? echo $row_rsGeneral['UsuarioCreacion']; ?></div></td>
		  </tr>
