...
<body>
<form id="form1" name="form1" method="post" autocomplete="Off" action="facupdateproceso2.php">
  <div style="height:25px">
    <input type="submit" name="Submit2" value="Actualizar" disabled="disabled" onclick="grabar()"/>
  &nbsp;&nbsp;&nbsp;
  <input type="button" name="Submit" value="Grabar" <? if($row_rsExisteCaja['Cantidad']==1){ if(empty($totalRows_rsItem)){ echo "disabled='disabled'"; } }else{ echo "disabled='disabled' title='Debe abrir Caja para Facturar'"; } ?> onclick="document.form1.action='facinsertproceso2.php'; document.form1.submit()"; />
  </div>
  <table class="table" width="595" border="0" cellpadding="0" cellspacing="2">
	...
	?>
      <tr>
        ...
        <td width="35" align="center"><a onclick="return confirmaborar()" href="facdelitem2.php?Codigo=<?php echo $row_rsItem['CodTemporal']; ?>"><img src="../imagenes/icono/trash.png" width="32" border="0" title="Eliminar"/></a></td>
      </tr>
      <?php 
