...
$rsArea=$objDatos->ObtenerGradoAreaSelAll();
?>
...
$(document).ready(function(){
	$("#btConsulta").click(function (){
	   ...
	   url: "php/concriterio.php", //SCRIPT que procesara los datos, establecer ruta relativa o absoluta
...
$jsObject_rsArea = new WDG_JsRecordset("rsArea");
echo $jsObject_rsArea->getOutput();
//end JSRecordset
?>
...
<table width="90%" border="0" align="center"><tr><td>
	<table width="100%" border="0" cellpadding="0">
		...
		<h1>Consulta de Criterios</h1><hr /><br />
		<form id="form1" name="form1" method="post" action="">
  <table width="670" border="0" cellspacing="2" cellpadding="0">
    <tr>
      <td>A&ntilde;o</td>
      <td>Nivel</td>
      <td>Grado</td>
    ...
    <tr>
      ...
      <td>
          <select name="cboArea" id="cboArea" style="width:200px" wdg:subtype="DependentDropdown"
			  wdg:type="widget" wdg:recordset="rsArea" wdg:displayfield="NombreArea" wdg:valuefield="CodArea"
	  ...
	  <td align="right">
        <input type="button" id="btConsulta" name="btReporte" value="Reporte" 
		onclick="document.form1.action='reporte/repcriterio.php'; document.form1.target='_blank'; document.form1.submit()";/>
      </td>
    </tr>
  </table>
  <div style="height:5px"></div>
