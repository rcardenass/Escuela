...
<table width="90%" border="0" align="center"><tr><td>
	<table width="100%" border="0" cellpadding="0">
		...
		<h1>
		<div style="width:100%">
			<div style="width:300px; height:auto; float:left; padding-top:20px">Nueva Cuenta Intranet Alumno</div>
			<div style="width:100px; height:auto; float:right; text-align:right">
				<a href="cuealumno.php"><img src="../imagenes/icono/revert.png" border="0" title="Personal con cuenta"/></a>
			</div>
		</div>
	    </h1><div style="height:30px"></div><hr /><br />
        <form action="cueinsertalumno.php" method="post" name="form1" id="form1" onsubmit="MM_validateForm('cboPerfil','','RisNum','cboUsuario','','RisNum','txtPassword','','R','txtRePassword','','R');return document.MM_returnValue" autocomplete="Off">
...
do {  
?>
                  <option value="<?php echo $row_rsAlumno['CodAlumno']?>"><?php echo $row_rsAlumno['Alumno']?></option>
                  <?php
