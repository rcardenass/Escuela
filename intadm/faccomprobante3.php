	...
	<table width="100%" border="0" cellpadding="0">
		...
		<div style="width:100%">
			...
			<div style="width:100px; height:auto; float:right; text-align:right">
				<a href="faccaja3.php"><img src="../imagenes/icono/revert.png" border="0" title="Busca otro Alumno"/></a>
			</div>
		</div>
		...
		<table width="600" border="0" cellspacing="1" cellpadding="0">
          <tr>
			...
			<table width="440" border="0" cellspacing="1" cellpadding="0">
              <tr>
                ...
                <td width="284"><?php echo $row_rsCab['CodCliente']; ?></td>
              </tr>
              <tr>
                <td width="110">Cliente</td>
                <td><?php echo $row_rsCab['Nombres']; ?></td>
              </tr>
              <tr>
                <td width="110">Direcci&oacute;n </td>
                <td><?php echo $row_rsCab['Direccion']; ?></td>
              </tr>
            </table></td>
          ...
          <tr>
			...
			if($totalRows_rsComprobante>0){ 
				do{
					$rsDetalle=$objDatos->ObtenerComprobantePrintSelAll($_GET['pqr'],$row_Comprobante['CodComprobante']);
					$row_Detalle=$objDatos->PoblarComprobantePrintSelAll($rsDetalle);
					
					$rsTotal=$objDatos->ObtenerComprobanteTotalSelId($_GET['pqr'],$row_Comprobante['CodComprobante']);
		...
		<a href="facimprimir3.php?Codigo=<?= $_GET['xyz']; ?>&&pqr=<?= $_GET['pqr']; ?>" rel="gb_page_center[650, 350]" title="Comprobante"><img src="../imagenes/icono/print.png" border="0" /></a>
		</div>
		<!-- InstanceEndEditable -->
		</div>
		<div style="height:10px"></div>
