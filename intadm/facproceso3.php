...
switch ($_GET['Tipo']) {
    case 'Concepto':
		...
		if($objDatos->InsertConceptoaTemporal(0,$_GET['Id'],$Tipo,$_SESSION['MM_Username'],$_GET['Modulo'])==1){
		}
        break;
    case 'Credito':
        $Tipo="Credito";
...
<script>
/*function refresh(){*/
	window.parent.Item3.location.reload();
/*	}
...
?>
<script>
	location.href="facconcepto3.php";
</script>