...
<table width="90%" border="0" align="center"><tr><td>
	<table width="100%" border="0" cellpadding="0">
		...
		<h1>Alumnos</h1><hr /><br />
		<form id="form1" name="form1" method="post" autocomplete="Off" action="php/acaalumnovinculapadre.php">
		...
		onclick='javascript: self.location.href=&quot;acaenlazapadrealumno.php&quot;'/>
            </td>
          </tr>
        </table>
		<div style="height:5px"></div>
