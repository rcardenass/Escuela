...
<table class="table" width="100%" border="0" cellspacing="2" cellpadding="0">
		  ...
		  ?>
            <? Filas();?>
              ...
              <td width="30px" align="center"><a href="acanewmatricula.php?Codigo=<?php echo $rowAlumno['CodAlumno']; ?>">
			  <img src="../imagenes/icono/edit.png" width="22" border="0" title="Seleccionar"/>
			  </a></td>
            </tr>
            <?php 
