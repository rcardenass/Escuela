...
<table class="table" width="100%" border="0" cellspacing="2" cellpadding="0">
	...
	if(!empty($totalRows_rsAlumno)){
		...
		?>
        <? Filas();?>
        	<td width="50"><div style="width:40px; float:right; text-align:right; padding-right:5px">
			<strong><?php echo $rowAlumno['CodAlumno']; ?></strong></div>
			</td>
			...
			<a href="faccaja.php?Codigo=<?php echo $rowAlumno['CodAlumno']; ?>">
			<img src="../imagenes/icono/edit.png" width="24" border="0" title="Ir"/></a>
			</td>
		</tr>
        <?php 
