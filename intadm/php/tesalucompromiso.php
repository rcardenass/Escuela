...
<table class="table" width="100%" border="0" cellspacing="2" cellpadding="0">
		  ...
		  ?>
           <? Filas();?>
              <td width="50"><div style="width:40px; float:right; text-align:right; padding-right:5px"><strong><?php echo $rowAlumno['CodAlumno']; ?></strong></div></td>
              ...
              <td width="30" align="center"><a href="tescompromiso.php?Codigo=<?php echo $rowAlumno['CodAlumno']; ?>"><img src="../imagenes/icono/informacion.png" width="22" border="0" title="Ir"/></a></td>
            </tr>
            <?php 
