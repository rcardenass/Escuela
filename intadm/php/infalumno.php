...
<table class="table" width="100%" border="0" cellspacing="2" cellpadding="0">
	...
	if(!empty($totalRows_rsAlumno)){
        ...
        <? Filas();?>
			...
			<a href="infalumnogeneral.php?Codigo=<?php echo $rowAlumno['CodAlumno']; ?>">
			<img src="../imagenes/icono/edit.png" width="20" border="0" title="Informe General"/></a>
			</td>
			<td width="32" align="center">
			<a href="infalumnodetalle.php?Codigo=<?php echo $rowAlumno['CodAlumno']; ?>">
			<img src="../imagenes/icono/edit.png" width="20" border="0" title="Informe Detalle"/></a>
			</td>
	</tr>
            <?php 
