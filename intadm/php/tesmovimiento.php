...
<table class="table" width="100%" border="0" cellspacing="2" cellpadding="0">
	<tr class="tr">
		<td width="30"><div style="text-align:right; padding-right:3px">Nro</div></td>
		<td width="120">Grado</td>
		<td>Alumno</td>
		<td width="70"><div style="text-align:right; padding-right:3px">Monto</div></td>
    ...
    if($totalRows_rsMovimiento>0){
        ...
        ?>
			<? Filas();?>
            	<td width="30"><div style="text-align:right; padding-right:3px"><strong><? echo $i;?></strong></div></td>
				<td width="120"><? echo utf8_encode($rowMovimiento['Grado']);?></td>
				<td><? echo utf8_encode($rowMovimiento['Alumno']);?></td>
				<td width="70"><div style="text-align:right; padding-right:3px"><? echo $rowMovimiento['Monto'];?></div></td>
