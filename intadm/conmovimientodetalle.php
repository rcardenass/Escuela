...
$(document).ready(function(){
	$("#btConsulta").click(function (){
	   ...
	   url: "php/conmovimientodetalle.php", //SCRIPT que procesara los datos, establecer ruta relativa o absoluta
...
<table width="90%" border="0" align="center"><tr><td>
	<table width="100%" border="0" cellpadding="0">
		...
		<h1>Movimientos Detallados</h1><hr /><br />
		<form action="" method="post" name="form1" id="form1" autocomplete="Off">
		  <table width="380" border="0" cellspacing="0" cellpadding="0">
			<tr>
			  <td width="90">Fecha</td>
			  <td width="210">Usuario</td>
			  <td>&nbsp;</td>
			</tr>
			<tr>
			  <td width="90">
					<input name="txtFecha" id="txtFecha" style="width:70px" wdg:subtype="SmartDate" wdg:mask="<?php echo $KT_screen_date_format; ?>" wdg:restricttomask="no" wdg:defaultnow="no" wdg:spinner="no" wdg:type="widget"/>
			  </td>
			  <td width="210">
