...
mysql_select_db($database_cn, $cn);
$query_rsLista = "SELECT a.CodAlumno, b.CodMatricula, concat(a.ApellidoPaterno,' ',a.ApellidoMaterno,' ',a.Nombres) AS Alumno, a.EmailPersonal FROM alumno a INNER JOIN matricula b ON b.CodAlumno=a.CodAlumno WHERE b.CodAnio='".$row_rsCursos['CodAnio']."' AND b.CodGrado='".$row_rsCursos['CodGrado']."' AND b.CodSeccion='".$row_rsCursos['CodSeccion']."' order by concat(a.ApellidoPaterno,' ',a.ApellidoMaterno,' ',a.Nombres) ";
	...
	<div style = "float: left; height: 450px; width: 100%; background-color:#cccccc">
		...
		<div style = "float: left; height: 450px; width: 59%; background-color:#9999CC; padding-left:5px">
			...
			<table width="95%" border="1" cellspacing="0" cellpadding="0">
              ...
              <?php do { ?>
              <tr>
                <td width="50"><?php echo $row_rsLista['CodAlumno']; ?></td>
                <td><?php echo $row_rsLista['Alumno']; ?></td>
                <td width="150"><?php echo $row_rsLista['EmailPersonal']; ?></td>
              </tr>
